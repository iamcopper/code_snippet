...
const static gpio_pinmux_t gpio_pinmux[] = {
	{{0, 'a', 0}, PINMUX_ADDR + 0x200, 24, 0x1},
	{{0, 'a', 1}, PINMUX_ADDR + 0x200, 20, 0x1},
	{{0, 'a', 2}, PINMUX_ADDR + 0x200, 16, 0x1},
	{{0, 'a', 3}, PINMUX_ADDR + 0x200, 12, 0x1},
	{{0, 'a', 4}, PINMUX_ADDR + 0x200,  8, 0x1},
	{{0, 'a', 5}, PINMUX_ADDR + 0x200,  4, 0x1},
	{{0, 'a', 6}, PINMUX_ADDR + 0x200,  0, 0x1},
	{{0, 'a', 7}, PINMUX_ADDR + 0x204, 28, 0x1},
	{{0, 'b', 0}, PINMUX_ADDR + 0x228, 24, 0x2},
	{{0, 'b', 1}, PINMUX_ADDR + 0x228, 20, 0x2},
	{{0, 'b', 2}, PINMUX_ADDR + 0x228, 16, 0x2},
	{{0, 'b', 3}, PINMUX_ADDR + 0x22C, 20, 0x2},
	{{0, 'b', 4}, PINMUX_ADDR + 0x22C, 16, 0x2},
	{{0, 'b', 5}, PINMUX_ADDR + 0x210,  0, 0x2},
	{{0, 'b', 6}, PINMUX_ADDR + 0x214,  8, 0x2},
	{{0, 'b', 7}, PINMUX_ADDR + 0x214,  4, 0x2},
	{{1, 'a', 0}, PINMUX_ADDR + 0x228, 12, 0x2},
	{{1, 'a', 1}, PINMUX_ADDR + 0x228,  8, 0x2},
	{{1, 'a', 2}, PINMUX_ADDR + 0x228,  4, 0x2},
	{{1, 'a', 3}, PINMUX_ADDR + 0x218, 12, 0x1},
	{{1, 'a', 4}, PINMUX_ADDR + 0x218,  8, 0x1},
	{{1, 'a', 5}, PINMUX_ADDR + 0x208, 16, 0x1},
	{{1, 'a', 6}, PINMUX_ADDR + 0x208, 12, 0x1},
	{{1, 'a', 7}, PINMUX_ADDR + 0x208,  8, 0x1},
	{{1, 'b', 0}, PINMUX_ADDR + 0x208,  4, 0x1},
	{{1, 'b', 1}, PINMUX_ADDR + 0x208,  0, 0x1},
	{{1, 'b', 2}, PINMUX_ADDR + 0x20C, 28, 0x1},
	{{1, 'b', 3}, PINMUX_ADDR + 0x20C, 24, 0x1},
	{{1, 'b', 4}, PINMUX_ADDR + 0x20C, 20, 0x1},
	{{1, 'b', 5}, PINMUX_ADDR + 0x20C, 16, 0x1},
	{{1, 'b', 6}, PINMUX_ADDR + 0x20C, 12, 0x1},
	{{1, 'b', 7}, PINMUX_ADDR + 0x214, 12, 0x1},
};
